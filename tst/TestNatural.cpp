...
TEST(NaturalTestSuite, TestDivision)
{
	...
	EXPECT_EQ(natural("42").divide_by(natural("7")).first, natural("6"));
	EXPECT_EQ(natural("42").divide_by(natural("7")).second, natural("0"));

	EXPECT_EQ(natural("56885154").divide_by(natural("7")).first, natural("8126450"));
	EXPECT_EQ(natural("56885154").divide_by(natural("7")).second, natural("4"));

	EXPECT_EQ(natural("56885154").divide_by(natural("9954984651")).first, natural("0"));
	EXPECT_EQ(natural("56885154").divide_by(natural("9954984651")).second, natural("56885154"));

	EXPECT_EQ(natural("84587134587163498576983174658973649875628374817239847162938461283746737621384921763984612837469823764987").divide_by(natural("2")).first, natural("42293567293581749288491587329486824937814187408619923581469230641873368810692460881992306418734911882493"));
	EXPECT_EQ(natural("84587134587163498576983174658973649875628374817239847162938461283746737621384921763984612837469823764987").divide_by(natural("2")).second, natural("1"));
	...
	auto ret = natural(very_large).divide_by(natural(divisor));
